...
def warmup_models():
    ...
    GroundingDINO(type=GroundingDINOModel.mmdet_SwinB),
    GroundingDINO(type=GroundingDINOModel.mmdet_SwinL),
    GroundingDINO(type=GroundingDINOModel.mmdet_SwinB_zero),
    GroundingDINO(type=GroundingDINOModel.mmdet_SwinL_zero),
